...
import RegistrarDocente from'./FormsDocente'

function ListViewDocente(props){
    return(
<React.Fragment>
            ...
            <div class=" center col-12  ">
                <div class="mb-5">
                    <div class="text-center">
                        <strong class="h4">Lista de Docentes</strong>
                    </div>
                    <RegistrarDocente/>
                    <div class="table-responsive-sm shadow-soft shadow-inset rounded">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td headers="firstyear2 Bolter2 males2"> Lcd.Juan Pedro</td>
...
export default ListViewDocente;