...
import RegistroTipoActividad from'./FormsTipoActividad';

function ListViewActividad(props){
    return(
<React.Fragment>
                        ...
                        <table class="table table-hover shadow-inset rounded">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td headers="firstyear2 Bolter2 males2"> Lecciones</td>
...
export default ListViewActividad;