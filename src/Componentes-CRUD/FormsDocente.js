...
function FormsDocente(){
    return(

        <React.Fragment>
        <div class="col-md-4"> 
                <button type="button" class="btn btn-block btn-primary mb-4" data-toggle="modal" data-target="#modal-form-Docente">
                Registrar Docente</button>
                
                <div class="modal fade" id="modal-form-Docente" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                ...
                                <div class="card bg-primary shadow-soft border-light p-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">                                                
                                            ...
                                            <div class="form-group">                                                    
                                                <input type="number" id="NumberInput" class="form-control" placeholder="Ingrese Cédula" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">                                                
